...
@TableGenerator(name = "ROLE_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME",
    valueColumnName = "GEN_VAL", pkColumnValue = "ROLE_GEN", allocationSize = 10)
@NamedQueries(
    value = {@NamedQuery(name = "Role.findAll", query = "SELECT m FROM Role m ORDER BY m.name ASC"),
