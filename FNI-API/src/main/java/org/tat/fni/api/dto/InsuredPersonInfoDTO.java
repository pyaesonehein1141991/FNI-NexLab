...
public class InsuredPersonInfoDTO {
  ...
  private Map<String, InsuredPersonAddOnDTO> insuredPersonAddOnDTOMap =
      new HashMap<String, InsuredPersonAddOnDTO>();
  ...
  public List<InsuredPersonBeneficiaries> getBeneficiariesInfoList(
    ...
    if (beneficiariesInfoDTOList != null && !beneficiariesInfoDTOList.isEmpty()) {
      ...
      for (BeneficiariesInfoDTO beneficiairesInfoDTO : beneficiariesInfoDTOList) {
        InsuredPersonBeneficiaries insPesBenf = new InsuredPersonBeneficiaries(
            beneficiairesInfoDTO.getBeneficiaryNo(), beneficiairesInfoDTO.getAge(),
            beneficiairesInfoDTO.getPercentage(), beneficiairesInfoDTO.getInitialId(),
            beneficiairesInfoDTO.getIdNo(), beneficiairesInfoDTO.getGender(),
            beneficiairesInfoDTO.getIdType(), beneficiairesInfoDTO.getResidentAddress(),
            beneficiairesInfoDTO.getName(), beneficiairesInfoDTO.getRelationship());;
  ...
  public List<InsuredPersonAddon> getInsuredPersonAddOnList(
    ...
    if (insuredPersonAddOnDTOList != null && !insuredPersonAddOnDTOList.isEmpty()) {
      for (InsuredPersonAddOnDTO insuredPersonAddonDTO : insuredPersonAddOnDTOList) {
        InsuredPersonAddon insAddOn = new InsuredPersonAddon(insuredPersonAddonDTO.getAddOn(),
            insuredPersonAddonDTO.getAddOnSumInsured());
  ...
  public String getFullAddress() {
    ...
    if (residentAddress.getResidentAddress() != null) {
      ...
      if (residentAddress.getTownship() != null
          && !residentAddress.getTownship().getName().isEmpty()) {
  ...
  public String setParentFullIdNo() {
    if (parentIdType.equals(IdType.NRCNO)) {
      parentFullIdNo = parentProvinceCode + "/" + parentTownshipCode + "(" + parentIdConditionType
          + ")" + parentIdNo;
