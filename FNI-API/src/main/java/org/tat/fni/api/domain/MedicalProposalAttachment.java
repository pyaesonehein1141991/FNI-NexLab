...
@TableGenerator(name = "MEDICALPROPOSALATTACHMENT_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME",
    valueColumnName = "GEN_VAL", pkColumnValue = "MEDICALPROPOSALATTACHMENT_GEN",
    allocationSize = 10)
