...
@TableGenerator(name = "SUBMENUVALUE_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME",
    valueColumnName = "GEN_VAL", pkColumnValue = "SUBMENUVALUE_GEN", allocationSize = 10)
@NamedQueries(
    value = {@NamedQuery(name = "SubMenuValue.findAll", query = "SELECT m FROM SubMenuValue m "),
        @NamedQuery(name = "SubMenuValue.findBySubMenuId",
            query = "SELECT m FROM SubMenuValue m WHERE m.subMenu.id = :subMenuId"),
        @NamedQuery(name = "SubMenuValue.findById",
            query = "SELECT m FROM SubMenuValue m WHERE m.id = :id")})
