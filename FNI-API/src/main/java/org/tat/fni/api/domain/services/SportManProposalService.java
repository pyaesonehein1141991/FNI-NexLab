...
public class SportManProposalService {
	...
	public List<LifeProposal> convertSportManDTOToProposal(SportManDTO sportMandto) {
		...
		try {
			...
			sportMandto.getProposalInsuredPersonList().forEach(insuredPerson -> {
				...
				lifeProposal.getProposalInsuredPersonList().add(createInsuredPersonForSportMan(insuredPerson));
	...
	private ProposalInsuredPerson createInsuredPersonForSportMan(SportManProposalInsuredPersonDTO dto) {
		try {
	...
	private InsuredPersonBeneficiaries createInsuredPersonBeneficiareis(SportManInsuredPersonBeneficiariesDTO dto) {
		try {
			Optional<Township> townshipOptional = townShipService.findById(dto.getTownshipId());
