...
@TableGenerator(name = "MAINMENUVALUE_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME",
    valueColumnName = "GEN_VAL", pkColumnValue = "MAINMENUVALUE_GEN", allocationSize = 10)
@NamedQueries(
    value = {@NamedQuery(name = "MainMenuValue.findAll", query = "SELECT m FROM MainMenuValue m "),
        @NamedQuery(name = "MainMenuValue.findByMainMenuId",
            query = "SELECT m FROM MainMenuValue m WHERE m.mainMenu.id = :mainMenuId"),
        @NamedQuery(name = "MainMenuValue.findById",
            query = "SELECT m FROM MainMenuValue m WHERE m.id = :id")})
