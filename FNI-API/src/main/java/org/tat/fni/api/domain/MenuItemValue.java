...
@TableGenerator(name = "MENUITEMVALUE_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME",
    valueColumnName = "GEN_VAL", pkColumnValue = "MENUITEMVALUE_GEN", allocationSize = 10)
@NamedQueries(
    value = {@NamedQuery(name = "MenuItemValue.findAll", query = "SELECT m FROM MenuItemValue m "),
        @NamedQuery(name = "MenuItemValue.findByMenuItemId",
            query = "SELECT m FROM MenuItemValue m WHERE m.menuItem.id = :menuItemId"),
        @NamedQuery(name = "MenuItemValue.findById",
            query = "SELECT m FROM MenuItemValue m WHERE m.id = :id")})
