...
@TableGenerator(name = "MAINMENU_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME",
    valueColumnName = "GEN_VAL", pkColumnValue = "MAINMENU_GEN", allocationSize = 10)
@NamedQueries(value = {
    @NamedQuery(name = "MainMenu.findAll",
        query = "SELECT m FROM MainMenu m ORDER BY m.priority ASC"),
