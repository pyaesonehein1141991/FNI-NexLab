...
@TableGenerator(name = "SUBMENU_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME",
    valueColumnName = "GEN_VAL", pkColumnValue = "SUBMENU_GEN", allocationSize = 10)
@NamedQueries(value = {
    @NamedQuery(name = "SubMenu.findAll", query = "SELECT m FROM SubMenu m ORDER BY m.name ASC"),
