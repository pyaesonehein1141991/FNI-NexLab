...
public class PersonalaccidentProposalService {
  ...
  public List<LifeProposal> createPersonalAccidentDtoToProposal(
  ...
  public List<LifeProposal> convertPersonalAccidentProposalDTOToProposal(
      PersonalAccidentDTO personalaccidentdto) {
    List<LifeProposal> lifeProposalList = new ArrayList<>();
    try {
      Optional<Organization> organizationOptional =
          organizationService.findById(personalaccidentdto.getOrganizationId());
      Optional<PaymentType> paymentTypeOptional =
          paymentTypeService.findById(personalaccidentdto.getPaymentTypeId());
      Optional<Agent> agentOptional = agentService.findById(personalaccidentdto.getAgentId());
      Optional<Customer> customerOptional =
          customerService.findById(personalaccidentdto.getCustomerId());
      ...
      Optional<SalesPoints> salesPointsOptional =
          salePointService.findById(personalaccidentdto.getSalesPointsId());
      ...
      personalaccidentdto.getProposalInsuredPersonList().forEach(insuredPerson -> {
        ...
        lifeProposal.getProposalInsuredPersonList()
            .add(createInsuredPersonForPersonalAccident(insuredPerson));
  ...
  private ProposalInsuredPerson createInsuredPersonForPersonalAccident(
      PersonalAccidentProposalInsuredPersonDTO dto) {
    try {
