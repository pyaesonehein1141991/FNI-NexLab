...
@TableGenerator(name = "MENUITEM_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME",
    valueColumnName = "GEN_VAL", pkColumnValue = "MENUITEM_GEN", allocationSize = 10)
@NamedQueries(value = {
    @NamedQuery(name = "MenuItem.findAll", query = "SELECT m FROM SubMenu m ORDER BY m.name ASC"),
