...
public class CriticalillnessProposalService {
	...
	public List<MedicalProposal> criticalillnessDTOToProposal(Object dtoObj) {
		try {
			// convert CriticalProposalDTO to lifeproposal
			List<MedicalProposal> criticalillnessProposalList = dtoObj instanceof IndividualCriticalIllnessDTO
					? convertIndividualCriticalillnessProposalDTOToProposal(
							(IndividualCriticalIllnessDTO) dtoObj)
					: convertGroupCriticalillnessProposalDTOToProposal(
							(GroupCriticalIllnessDTO) dtoObj);
	...
	public List<MedicalProposal> convertIndividualCriticalillnessProposalDTOToProposal(
	...
	public List<MedicalProposal> convertGroupCriticalillnessProposalDTOToProposal(
			GroupCriticalIllnessDTO criticalIllnessDTO) {
		List<MedicalProposal> medicalProposalList = new ArrayList<>();
		try {
			Optional<Organization> organizationOptional = organizationService
					.findById(criticalIllnessDTO.getOrganizationId());
