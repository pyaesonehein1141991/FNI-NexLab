...
public class MicroHealthProposalService {
	...
	public List<MedicalProposal> createMicroHealthDtoToProposal(MicroHealthDTO microHealthInsuranceDTO) {
		try {
			// convert MicroHealthProposalDTO to lifeproposal
			List<MedicalProposal> microHealthProposalList = convertMicroHealthProposalDTOToProposal(microHealthInsuranceDTO);
	...
	public List<MedicalProposal> convertMicroHealthProposalDTOToProposal(MicroHealthDTO microHealthInsuranceDTO) {
		...
		try {
			...
			microHealthInsuranceDTO.getMicrohealthproposalInsuredPersonList().forEach(insuredPerson -> {
				...
				medicalProposal.getMedicalProposalInsuredPersonList().add(createInsuredPersonForMicroHealth(insuredPerson));
	...
	private MedicalProposalInsuredPerson createInsuredPersonForMicroHealth(MicroHealthProposalInsuredPersonDTO dto) {
		try {
	...
	private MedicalProposalInsuredPersonBeneficiaries createInsuredPersonBeneficiareis(MicroHealthProposalInsuredPersonBeneficiariesDTO dto) {
		try {
